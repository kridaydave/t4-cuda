...
| **Signed INT4 Dequant (`LOP3` LUT `0x78`)** | Single-cycle sign bit 3 inversion + FP16 magic exponent `0x64086408` insertion. | **1 SASS cycle** ($2.5\times$ instruction reduction over `bfe`). | **T4 Adaptation**: Extends established FP16 magic number insertion to signed INT4. *(Status: Mathematically Verified)* |
