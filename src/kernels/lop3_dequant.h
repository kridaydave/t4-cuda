...
#ifdef __CUDACC__
// Pure PTX Unsigned INT4 Dequantization (0xF8 + fma.rn.f16x2)
    ...
    uint32_t scale_32, uint32_t neg_bias_32) 
{
    ...
    // 1. Bitwise LOP3 LUT 0xF8: (A & B) | C
    asm volatile("lop3.b32 %0, %1, %2, %3, 0xF8;" : "=r"(raw_04) : "r"(W),       "r"(mask_even), "r"(magic_exp));
    asm volatile("lop3.b32 %0, %1, %2, %3, 0xF8;" : "=r"(raw_15) : "r"(W >> 4),  "r"(mask_even), "r"(magic_exp));
    asm volatile("lop3.b32 %0, %1, %2, %3, 0xF8;" : "=r"(raw_26) : "r"(W >> 8),  "r"(mask_even), "r"(magic_exp));
    asm volatile("lop3.b32 %0, %1, %2, %3, 0xF8;" : "=r"(raw_37) : "r"(W >> 12), "r"(mask_even), "r"(magic_exp));
...
{
    const uint32_t mask_even = 0x000F000F;
    const uint32_t magic_exp = 0x64086408; // 1032.0 FP16 (Exponent 1024.0 FP16 + bit 3 & bit 19 set)
